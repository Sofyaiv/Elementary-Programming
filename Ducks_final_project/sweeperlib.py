...
def load_sprites(path):
    ...
    images["dot"] = pyglet.resource.image("haha.png")
    images["obstacle1"] = pyglet.resource.image("obstacle1.png")
    images["obstacle2"] = pyglet.resource.image("obstacle2.png")
    images["obstacle3"] = pyglet.resource.image("obstacle3.png")
    images["target1"] = pyglet.resource.image("target1.png")
    images["lose"] = pyglet.resource.image("lose.png")
    images["menu"] = pyglet.resource.image("menu.png")
    images["background"] = pyglet.resource.image("background.png")
    images["target2"] = pyglet.resource.image("target2.png")
    images["target3"] = pyglet.resource.image("target3.png")
    images["menu1"] = pyglet.resource.image("menu1.png")
    images["menu2"] = pyglet.resource.image("menu2.png")
    images["menu3"] = pyglet.resource.image("menu3.png")
    images["grey2"] = pyglet.resource.image("grey2.png")
    images["grey3"] = pyglet.resource.image("grey3.png")
    images["lives"] = pyglet.resource.image("lives.png")
    images["tryagain"] = pyglet.resource.image("tryagain.png")
...
def create_window(width=800, height=600, bg_color=(255, 195, 200, 255)):
    """
